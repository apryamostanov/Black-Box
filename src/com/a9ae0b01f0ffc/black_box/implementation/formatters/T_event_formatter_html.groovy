...
class T_event_formatter_html extends T_event_formatter implements I_event_formatter {
    ...
    String format_traces(ArrayList<I_trace> i_event_traces, I_event i_source_event) {
        ...
        l_result += "<tr>"
        String l_datetimestamp = T_const.GC_EMPTY_STRING
        String l_processid = T_const.GC_EMPTY_STRING
        String l_event_type = T_const.GC_EMPTY_STRING
        String l_class_name = T_const.GC_EMPTY_STRING
        String l_method_name = T_const.GC_EMPTY_STRING
        String l_depth = T_const.GC_EMPTY_STRING
        String l_trace_data = T_const.GC_EMPTY_STRING
