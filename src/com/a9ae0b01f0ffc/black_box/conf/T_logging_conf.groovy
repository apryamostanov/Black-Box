...
class T_logging_conf extends T_common_conf {
    ...
    T_logging_conf(String i_conf_file_name) {
        ...
        GC_MAX_TRACE_LENGTH = GC_CONST_CONF.GC_MAX_TRACE_LENGTH(GC_MAX_TRACE_LENGTH)
        GC_MAX_CODE_LENGTH = GC_CONST_CONF.GC_MAX_CODE_LENGTH(GC_MAX_CODE_LENGTH)
        GC_ASYNC_STORER_POLL_PERIOD_MILLIS = GC_CONST_CONF.GC_ASYNC_STORER_POLL_PERIOD_MILLIS(GC_ASYNC_STORER_POLL_PERIOD_MILLIS)
        GC_ASYNC_STORER_STORE_PERIOD_MILLIS = GC_CONST_CONF.GC_ASYNC_STORER_STORE_PERIOD_MILLIS(GC_ASYNC_STORER_STORE_PERIOD_MILLIS)
    }
