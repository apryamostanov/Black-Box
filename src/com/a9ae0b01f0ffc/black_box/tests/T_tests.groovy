...
/*
    ...
    @Test
    void test_002() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_002.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD)
    ...
    @Test
    void test_003() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_003.conf")
        T_s.l().put_to_context(new T_pan(PC_PAN), "pan")
        T_s.l().log_info(T_s.s().HELLO_WORLD)
        assert T_destination_variable.l() == "Unknown Class|Unknown Method|0|info|HELLO_WORLD|T_pan(4447778899992222)" + System.lineSeparator()
    }

    @Test
    void test_004() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_004.conf")
        T_s.l().put_to_context(new T_pan(PC_PAN), "pan")
        T_s.l().log_info(T_s.s().HELLO_WORLD)
    ...
    @Test
    void test_005() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_005.conf")
    ...
    @Test
    void test_006() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_006.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
        assert T_destination_variable.l() == "Unknown Class|Unknown Method|0|info|HELLO_WORLD|Trace missing" + System.lineSeparator()
    }
    ...
    @Test
    void test_007() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_007.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
    ...
    @Test
    void test_008() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_008.conf")
    ...
    @Test
    void test_009() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_009.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable(PC_PAN), "pan"))
    ...
    @Test
    void test_010() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_010.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
        assert T_destination_variable.l() == "Unknown Class|Unknown Method|0|info|HELLO_WORLD|Trace masked" + System.lineSeparator()
    }
    ...
    @Test
    void test_011() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_011.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
        assert T_destination_variable.l() == "T_pan(4447778899992222)" + System.lineSeparator()
    }

    @Test
    void test_012() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_012.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
    ...
    @Test
    void test_013() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_013.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable(PC_PAN), "pan"))
    ...
    @Test
    void test_014() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_014.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable(PC_PAN), "pan"))
        assert T_destination_variable.l() == "Trace masked" + System.lineSeparator()
    }
    ...
    @Test
    void test_015() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_015.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable(PC_PAN), "pan"))
        assert T_destination_variable.l() == "Trace masked" + System.lineSeparator()
    }
    ...
    @Test
    void test_016() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_016.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
        assert T_destination_variable.l() == "T_pan(4447778899992222)" + System.lineSeparator()
    }
    ...
    @Test
    void test_017() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_017.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
        assert T_destination_variable.l() == "Trace masked" + System.lineSeparator()
    }
    ...
    @Test
    void test_018() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_018.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable(PC_PAN), "pan"))
        assert T_destination_variable.l() == "444777******2222" + System.lineSeparator()
    }
    ...
    @Test
    void test_019() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_019.conf")
    ...
    @Test
    void test_020() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_020.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan(PC_PAN), "pan"))
        assert T_destination_variable.l() == "Trace masked|444777******2222" + System.lineSeparator()
    }
    ...
    @Test
    void test_021() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_021.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan("4447778899992223"), "pan"))
        assert T_destination_variable.l() == "T_pan(4447778899992223)|**********2222" + System.lineSeparator()
    }

    @Test
    void test_022() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_022.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan("4447778899992223"), "pan"))
    ...
    @Test
    void test_023() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_023.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
        try {
    ...
    @Test
    void test_024() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_024.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
        try {
    ...
    void test_025() {
        ...
        String l_expected = "    <event>\n" +
                ...
                "        <trace name=\"i_pan\" serialized_representation=\"T_pan(4447778899992223)\" source=\"runtime\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan\" masked=\"false\" />\n" +
                "        <trace name=\"pan\" serialized_representation=\"T_pan_maskable(4447778899992222)\" source=\"context\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan_maskable\" masked=\"false\" />\n" +
                "    </event>\n"
    ...
    void test_026() {
        ...
        String l_expected = "    <event>\n" +
                ...
                "        <trace name=\"exception_message\" serialized_representation=\"Trace missing\" source=\"predefined\" mask=\"\" ref_class_name=\"\" masked=\"false\" />\n" +
                "        <trace name=\"message\" serialized_representation=\"null\" source=\"predefined\" mask=\"\" ref_class_name=\"\" masked=\"false\" />\n" +
                "        <trace name=\"result_pan\" serialized_representation=\"T_pan(4447778899992225)\" source=\"runtime\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan\" masked=\"false\" />\n" +
                "        <trace name=\"pan\" serialized_representation=\"T_pan_maskable(4447778899992222)\" source=\"context\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan_maskable\" masked=\"false\" />\n" +
                "    </event>\n"
        assert T_destination_variable.l() == l_expected.replaceAll("\n", "\r\n")
    }
    ...
    void test_027() {
        ...
        String l_expected = "    <event>\n" +
                ...
                "        <trace name=\"message\" serialized_representation=\"null\" source=\"predefined\" mask=\"\" ref_class_name=\"\" masked=\"false\" />\n" +
                "        <trace name=\"exception_pan\" serialized_representation=\"T_pan_maskable(4447778899992223)\" source=\"runtime\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan_maskable\" masked=\"false\" />\n" +
                "        <trace name=\"pan\" serialized_representation=\"T_pan_maskable(4447778899992222)\" source=\"context\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan_maskable\" masked=\"false\" />\n" +
                "        <trace name=\"\" serialized_representation=\"T_pan_maskable(4447778899992224)\" source=\"exception_traces\" mask=\"\" ref_class_name=\"com.a9ae0b01f0ffc.black_box.tests.mockup.T_pan_maskable\" masked=\"false\" />\n" +
                "    </event>\n"
        assert T_destination_variable.l() == l_expected.replaceAll("\n", "\r\n")
    }
    ...
    @Test
    void test_029() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_029.conf")
        String w = new T_sample_class_for_annotation_test().do_something("aaa", "bbb")
    }

    @Test
    void test_030() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_030.conf")
        String w = new T_sample_class_for_annotation_test().do_something3("aaa", "aa2a")
    }

    @Test
    void test_031() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_031.conf")
        try {
    ...
    @Test
    void test_032() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_032.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan("4447778899992223"), "pan"))
    ...
    @Test
    void test_033() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_033.conf")
        T_s.l().put_to_context(new T_pan_maskable(PC_PAN), "pan")
    ...
    @Test
    void test_034() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_034.conf")
    ...
    @Test
    void test_035() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_035.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable("4447778899992221"), "T_pan_maskable"), T_s.r(new T_pan_sensitive("4447778899992222"), "T_pan_sensitive"), T_s.r(new T_pan_non_sensitive("4447778899992223"), "T_pan_non_sensitive"), T_s.r(new T_pan("4447778899992224"), "T_pan"))
        assert T_destination_variable.l() == "info|HELLO_WORLD|444777******2221|Trace masked|T_pan_non_sensitive(4447778899992223)|T_pan(4447778899992224)" + System.lineSeparator()
    }

    @Test
    void test_036() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_036.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable("4447778899992221"), "T_pan_maskable"), T_s.r(new T_pan_sensitive("4447778899992222"), "T_pan_sensitive"), T_s.r(new T_pan_non_sensitive("4447778899992223"), "T_pan_non_sensitive"), T_s.r(new T_pan("4447778899992224"), "T_pan"))
        assert T_destination_variable.l() == "info|HELLO_WORLD|444777******2221|Trace masked|T_pan_non_sensitive(4447778899992223)|Trace masked" + System.lineSeparator()
    }

    @Test
    void test_037() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_037.conf")
        T_s.l().log_info(T_s.s().HELLO_WORLD, T_s.r(new T_pan_maskable("4447778899992221"), "T_pan_maskable"), T_s.r(new T_pan_sensitive("4447778899992222"), "T_pan_sensitive"), T_s.r(new T_pan_non_sensitive("4447778899992223"), "T_pan_non_sensitive"), T_s.r(new T_pan("4447778899992224"), "T_pan"))
        assert T_destination_variable.l() == "info|HELLO_WORLD|T_pan_maskable(4447778899992221)|T_pan_sensitive(4447778899992222)|T_pan_non_sensitive(4447778899992223)|T_pan(4447778899992224)" + System.lineSeparator()
    }

    @Test
    void test_038() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_038.conf")
        String w = new T_sample_class_for_annotation_test().do_something5("aaa", "a1aa")
    }

    @Test
    void test_039() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_039.conf")
        String w = new T_sample_class_for_annotation_test().reissue_card("555555555555555")
    }

    @Test
    void test_040() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_040.conf")
        assert 41 == new T_case_investigations().get_value_position()
    }

    @Test
    void test_041() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_041.conf")
    ...
    @Test
    void test_042() {
        T_s.x().init_custom_with_custom_logger(PC_COMMONS_CONF_NAME, PC_TEST_CONF_PATH + "main_042.conf")
        try {
